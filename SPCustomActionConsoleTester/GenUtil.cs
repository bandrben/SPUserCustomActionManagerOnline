...
namespace BandR
{
    ...
    public static class GenUtil
    {
        ...
        public static string CleanUsername(object username)
        {
            ...
            un = un.Substring(un.LastIndexOf('#') + 1); // ex: 1073741823;#System Account, or 2;#Ben Steinhauser
            un = un.Substring(un.LastIndexOf('|') + 1); // ex: i:0#.w|domain\spuser
        ...
        public static List<string> ConvertStringToList(string str)
        {
            ...
            if (str.Contains(";"))
            {
                foreach (string cur_str in str.Split(";".ToCharArray()))
                {
